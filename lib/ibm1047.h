...
static const unsigned short ibm1047_2uni[256] =
{
  ...
  [0xac] = 0x00d0, [0xad] = 0x005b, [0xae] = 0x00de, [0xaf] = 0x00ae,
  [0xb0] = 0x00ac, [0xb1] = 0x00a3, [0xb2] = 0x00a5, [0xb3] = 0x00b7,
  [0xb4] = 0x00a9, [0xb5] = 0x00a7, [0xb6] = 0x00b6, [0xb7] = 0x00bc,
  [0xb8] = 0x00bd, [0xb9] = 0x00be, [0xba] = 0x00dd, [0xbb] = 0x00a8,
  [0xbc] = 0x00af, [0xbd] = 0x005d, [0xbe] = 0x00b4, [0xbf] = 0x00d7,
...
static int
ibm1047_mbtowc (conv_t conv, ucs4_t *pwc, const unsigned char *s, size_t n)
{
   unsigned char c = *s;
   *pwc = (ucs4_t) ibm1047_2uni[c];
   return 1;
}

static const unsigned char ibm1047_page00[] = {
  ...
  '\x41', '\xaa', '\x4a', '\xb1', '\x9f', '\xb2', '\x6a', '\xb5',
  '\xbb', '\xb4', '\x9a', '\x8a', '\xb0', '\xca', '\xaf', '\xbc',
  ...
  '\x80', '\xfd', '\xfe', '\xfb', '\xfc', '\xba', '\xae', '\x59',
...
static int
ibm1047_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, size_t n)
   {
      unsigned char c = 0;
      if (wc >= 0x0 && wc < 0x0100)
         c = ibm1047_page00[wc];
