...
static const unsigned short ibm1145_2uni[256] =
{
...
static int
ibm1145_mbtowc (conv_t conv, ucs4_t *pwc, const unsigned char *s, size_t n)
{
  unsigned char c = *s;
  *pwc = (ucs4_t) ibm1145_2uni[c];
  return 1;
}

static const unsigned char ibm1145_page00[] = {
...
static int
ibm1145_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, size_t n)
{
   unsigned char c = 0;
   if (wc >= 0x0 && wc < 0x0100)
      c = ibm1145_page00[wc];
